...
#[case::with_destracturing_symbol(fixtures::let_like::simple_let_with_destructuring_symbol())]
#[case::nested_let_with_thread_macro_cond(fixtures::let_like::nested_let_with_thread_macro_cond())]
#[case::with_multiline_destracturing(fixtures::let_like::simple_let_with_multiline_destructuring_symbol())]
